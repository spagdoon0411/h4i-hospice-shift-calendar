import { eventShiftsFormatted } from "./sampleData.js";
...
export default function NewCalendar() {
        ...
        const extendedInfoElement = (
            <div id="extended-info">
                <div className="extended-info-member">
                    ...
                    <div className="extended-info-text">
                        {volunteerName}
                    </div>
                </div>
                <div className="extended-info-member">
    ...
    const extendedInfoPlaceholder = (
        <div id="extended-info-placeholder">
            <img id="mouse-over-icon" src={mouseOverIcon}/>
        </div>
    )
    ...
    const minimizedCalendar = <FullCalendar
